...
public class BasicJoinCsv {
    ...
    public static void main(String[] args) throws Exception {
        args = new String[]{"local", "./files/1.csv", "./files/2.csv"};
        if (args.length != 3) {
    ...
    public void run(String master, String csv1, String csv2) throws Exception {
        ...
        for (Tuple2<Integer, Tuple2<String[], String[]>> tuple2 : resultCollection) {
//            System.out.println(tuple2.toString());
            System.out.println(tuple2._1() + "   " + Arrays.asList(tuple2._2()._1()) + "   " + Arrays.asList(tuple2._2()._2()));
        }
    }
